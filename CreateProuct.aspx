<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateProuct.aspx.cs" Inherits="CRUD_Project.CreateProuct" %>
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="form-group row">
                        <div class="col-md-10 mt-4 d-flex justify-content-center">
                            <asp:Button CssClass="btn btn-outline-primary" ID="AddProductbtn" runat="server" Text="Add Product" OnClick="AddProductbtn_Click" />
                        </div>
                    </div>

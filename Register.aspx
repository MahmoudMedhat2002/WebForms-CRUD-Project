<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="CRUD_Project.Register" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                    <asp:Label Font-Bold="true" Font-Size="20" CssClass="text-center" ID="Label3" runat="server" Text="Register"></asp:Label>
                    ...
                    <div class="text-center mt-3">
                        <asp:Button CssClass="btn btn-outline-primary" ID="Registerbtn" runat="server" Text="Register" OnClick="Registerbtn_Click" />
                    </div>
